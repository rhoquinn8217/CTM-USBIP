...
{"key":"touchpad_click_buttons","type":"bool","default":false,"help":"Pressing the touchpad in clicks a mouse button, chosen by which HALF your finger is on: left half is left click, right half is right click. Held past the drag delay it becomes a drag. Takes the place of touchpad_click_drag, which cannot run beside it -- both hold a button from the same physical click."},
{"key":"touchpad_drag_hold_ms","type":"int","min":0,"max":2000,"default":200,"help":"How long the touchpad's click is held before it becomes a drag, in milliseconds. The wait is what lets the jolt of the click die away, so a click does not arrive as a small drag. 0 turns dragging off and leaves the click alone."},
...
{"key":"gyro_to_mouse_gate","type":"choice","choices":["","always","L2","R2","L1","R1","touchpad","!touchpad","touchpad_click","steady","PS"],"default":"","help":"What must be held for gyro to move the mouse. Blank is off. \"steady\" is the ratchet with a way back: a finger on the touchpad freezes the cursor, and a click held past the drag delay hands it back so you can drag."},
