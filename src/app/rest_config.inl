...
{"key":"gyro_to_mouse_gate","type":"choice","choices":["","always","L2","R2","L1","R1","R3","touchpad","!touchpad","touchpad_click","PS"],"default":"","help":"What must be held for gyro to move the mouse. Blank is off. A trigger set to steady the cursor suppresses the gyro on top of whichever gate is chosen, so the two can be combined."},
