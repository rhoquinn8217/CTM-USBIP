...
{"key":"trigger_r2_effect","type":"choice","choices":["","off","click","wall"],"default":"","help":"A resistance effect on R2. \"click\" puts a break at the point below, so the finger can feel where a trigger click fires. \"wall\" is steady resistance from that point down. Blank leaves the trigger alone; \"off\" clears an effect this listener set. Wired controllers only."},
{"key":"trigger_r2_effect_at","type":"int","min":0,"max":100,"default":50,"help":"Where in the pull the R2 effect sits, as a percent of the travel. A \"click\" break can only land between 30 and 80 percent, and is moved to the nearest of those if you ask for more."},
{"key":"trigger_r2_effect_strength","type":"int","min":1,"max":8,"default":6,"help":"How hard the R2 effect pushes back, 1 lightest to 8 heaviest."},
{"key":"trigger_l2_effect","type":"choice","choices":["","off","click","wall"],"default":"","help":"A resistance effect on L2, the same as the R2 setting above."},
...
{"key":"trigger_l2_effect_strength","type":"int","min":1,"max":8,"default":6,"help":"How hard the L2 effect pushes back, 1 lightest to 8 heaviest."},
