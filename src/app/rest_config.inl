...
{"key":"right_trigger_freezes_cursor","type":"bool","default":false,"name":"RIGHT trigger steadies the cursor","help":"While you work the right trigger, hold the cursor still. It freezes as soon as you start pulling, whatever the (R2) remap sends fires further down rather than straight away, and holding past the drag time lets the cursor move again with the button still held. Off, the trigger is an ordinary button."},
{"key":"right_trigger_press_at","type":"int","min":10,"max":100,"default":80,"name":"RIGHT trigger presses at","help":"How far the right trigger travels before it presses, as a percent. Only used when it steadies the cursor, and ignored when its effect is \"click\" or \"wall\", which report their own point."},
...
{"key":"right_trigger_effect_at","type":"int","min":0,"max":100,"default":50,"name":"RIGHT trigger feel sits at","help":"Where the right effect sits, as a percent. Blank follows the point the trigger sends at. A \"click\" break can only land between 40 and 90."},
...
{"key":"left_trigger_freezes_cursor","type":"bool","default":false,"name":"LEFT trigger steadies the cursor","help":"While you work the left trigger, hold the cursor still. It freezes as soon as you start pulling, whatever the (L2) remap sends fires further down rather than straight away, and holding past the drag time lets the cursor move again with the button still held. Off, the trigger is an ordinary button."},
{"key":"left_trigger_press_at","type":"int","min":10,"max":100,"default":80,"name":"LEFT trigger presses at","help":"How far the left trigger travels before it presses, as a percent. Only used when it steadies the cursor, and ignored when its effect is \"click\" or \"wall\", which report their own point."},
...
{"key":"left_trigger_effect_at","type":"int","min":0,"max":100,"default":50,"name":"LEFT trigger feel sits at","help":"Where the left effect sits, as a percent. Blank follows the point the trigger sends at."},
...
{"key":"trigger_freeze_at","type":"int","min":4,"max":50,"default":15,"name":"Both triggers: cursor freezes at","help":"How far either trigger moves before the cursor freezes, as a percent. Keep it clear of where the trigger rests, which sits higher when an effect is set."},
{"key":"trigger_drag_after_ms","type":"int","min":0,"max":2000,"default":600,"name":"Both triggers: hold becomes a drag after","help":"How long a press is held before it becomes a drag, in milliseconds. 0 turns dragging off."},
{"key":"trigger_double_click_ms","type":"int","min":0,"max":1000,"default":200,"name":"Both triggers: cursor waits for a second click","help":"After a click, how long the cursor stays still in case a second one follows, in milliseconds. Longer makes double-clicking easier and makes the cursor feel slower to respond. 0 frees it the moment the trigger is released."},
