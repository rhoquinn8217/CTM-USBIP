...
{"key":"trigger_right_click_at","type":"int","min":10,"max":100,"default":80,"name":"RIGHT trigger fires at","help":"How far the RIGHT trigger must travel before it sends, as a percent of the pull. Deeper is steadier, because the finger has settled by the time it fires."},
...
{"key":"trigger_left_click_at","type":"int","min":10,"max":100,"default":80,"name":"LEFT trigger fires at","help":"How far the LEFT trigger must travel before it sends, as a percent of the pull."},
...
{"key":"trigger_probe","type":"bool","default":false,"name":"Both triggers: log the raw report","help":"Diagnostic. Logs any input-report byte that changes, ignoring the ones that always change, so a field like the adaptive trigger break can be identified. Noisy; leave it off."},
