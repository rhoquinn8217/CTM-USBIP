...
{"key":"trigger_r2_effect","type":"choice","choices":["","off","click","wall","notch"],"default":"","help":"A resistance effect on R2. \"click\" puts a break at the point below, so the finger can feel where a trigger click fires. \"wall\" is steady resistance from that point down. \"notch\" is both at once: a firm lip at the point, then a wall below it. Blank leaves the trigger alone; \"off\" clears an effect this listener set. Wired controllers only."},
