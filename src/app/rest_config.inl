...
{"key":"trigger_probe","type":"bool","default":false,"help":"Diagnostic. Logs any input-report byte that changes, ignoring the ones that always change, so the byte carrying the adaptive trigger break can be identified. Noisy; leave it off."},
