...
{"key":"trigger_drag_after_ms","type":"int","min":0,"max":2000,"default":600,"name":"Both triggers: hold becomes a drag after","help":"How long a press is held before it becomes a drag, in milliseconds. It is also the double-press window. 0 turns dragging off."},
