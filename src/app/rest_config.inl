...
{"key":"mouse_exclusive_gyro","type":"bool","default":false,"help":"When the gyro is moving the cursor, hide the gyro from the game. Without this you are aiming twice at once -- the cursor moves AND the camera turns. Only applies while gyro-to-mouse is set."},
{"key":"mouse_exclusive_touchpad","type":"bool","default":false,"help":"When the touchpad is moving the cursor or scrolling, hide it from the game -- finger positions and the touchpad click. Only applies while a touchpad mouse setting is on."},
{"key":"mouse_exclusive_stick","type":"bool","default":false,"help":"When a stick is moving the cursor or scrolling, hide THAT stick from the game. The other stick is untouched, so it can still walk. Only applies to a stick that is actually mapped."},
