...
{"key":"trigger_r2_effect","type":"choice","choices":["","off","click","wall","notch"],"default":"","help":"A resistance effect on R2. \"click\" puts a break at the point below, so the finger can feel where a trigger click fires. \"wall\" is steady resistance from that point down. \"notch\" is both at once: resistance that climbs from early in the pull and lets go at the point. Blank leaves the trigger alone; \"off\" clears an effect this listener set. Wired controllers only."},
...
{"key":"trigger_l2_effect","type":"choice","choices":["","off","click","wall","notch"],"default":"","help":"A resistance effect on L2, the same as the R2 setting above."},
