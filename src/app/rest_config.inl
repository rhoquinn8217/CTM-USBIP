...
{"key":"gyro_to_mouse_gate_type","type":"choice","choices":["","until_held","while_held"],"default":"","name":"Gyro moves the mouse","help":"Blank is off. \"until_held\" means the gyro moves the cursor and holding the button below STOPS it; with no button chosen that is simply always on. \"while_held\" means it moves only while that button is held. A trigger set to steady the cursor suppresses the gyro on top of either, so the two can be combined."},
{"key":"gyro_to_mouse_gate_button","type":"choice","choices":["","l2","r2","l1","r1","l3","r3","touchpad","touchpad_click","face_down","face_right","face_left","face_up","dpad_up","dpad_down","dpad_left","dpad_right","select","start","home"],"default":"","name":"...and this button gates it","help":"Any button on the pad, plus a finger resting on the touchpad and the touchpad pressed in. Leave it blank to mean no button at all: with \"until_held\" that is always on, and with \"while_held\" it is off."},
