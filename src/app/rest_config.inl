...
{"key":"trigger_r2_effect","type":"choice","choices":["","off","click","wall","notch","snap"],"default":"","help":"A resistance effect on R2. \"click\" puts a break at the point below, so the finger can feel where a trigger click fires. \"wall\" is steady resistance from that point down. \"notch\" is both at once: a light wall the whole way down with one firm detent in it, at the point. The wall is flat, so moving the point changes WHERE the detent is rather than how hard the pull is. \"snap\" is a break like \"click\" that also pushes the trigger back to rest afterwards, so it returns itself instead of waiting for your finger to relax. Blank leaves the trigger alone; \"off\" clears an effect this listener set. Wired controllers only."},
{"key":"trigger_r2_effect_at","type":"int","min":0,"max":100,"default":50,"help":"Where in the pull the R2 effect sits, as a percent of the travel. A \"click\" break can only land between 30 and 90 percent, and is moved to the nearest of those if you ask for more. A \"wall\" can start anywhere."},
...
{"key":"trigger_l2_effect","type":"choice","choices":["","off","click","wall","notch","snap"],"default":"","help":"A resistance effect on L2, the same as the R2 setting above."},
{"key":"trigger_l2_effect_at","type":"int","min":0,"max":100,"default":50,"help":"Where in the pull the L2 effect sits, as a percent of the travel."},
{"key":"trigger_l2_effect_strength","type":"int","min":1,"max":7,"default":5,"help":"How hard the L2 effect pushes back, 1 lightest and 7 firmest."},
{"key":"trigger_r2_snap_force","type":"int","min":1,"max":7,"default":3,"help":"How hard the \"snap\" effect pushes R2 back toward rest once you ease off. Only used by \"snap\". Set too high it will fight you on the way down as well as on the way back."},
{"key":"trigger_l2_snap_force","type":"int","min":1,"max":7,"default":3,"help":"How hard the \"snap\" effect pushes L2 back toward rest once you ease off."},
...
{"key":"trigger_r2_click","type":"bool","default":false,"help":"R2 clicks the left mouse button once it passes the point below. Starting to pull freezes the cursor, so the click lands still; a full release hands it back. Pair it with an R2 effect set to the same point, so the finger can feel where the click is."},
...
{"key":"trigger_l2_click","type":"bool","default":false,"help":"L2 clicks the right mouse button, otherwise the same as the R2 setting above."},
...
{"key":"trigger_click_hold_ms","type":"int","min":0,"max":2000,"default":200,"help":"How long a trigger click is held before it becomes a drag, in milliseconds. This is also the double-click window: hold for less and a second press is a double click with the cursor still frozen, hold for longer and the cursor comes back with the button still down. 0 turns dragging off."},
